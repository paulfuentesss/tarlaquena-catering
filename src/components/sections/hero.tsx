    ...
    <section className="bg-cream px-6 pt-14 pb-10 sm:px-10 lg:px-16">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
          ...
          <div className="flex size-20 shrink-0 items-center justify-center rounded-full bg-coral text-center text-[0.6rem] font-semibold uppercase leading-tight text-white">
